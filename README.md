# AI Safety Evaluation Blog

🛡️ Building evaluation infrastructure that keeps advanced AI aligned

## About

This blog documents my journey building practical AI safety evaluation tools — from chain-of-thought faithfulness to multi-agent governance, from research prototypes to production systems.
...
- `publish_ai_safety_blog.sh` — Script to publish to GitHub Pages
...
`https://saviaga.github.io/ai-safety-blog/`
...
2. Beyond Single-Query Safety: Detecting Coordinated LLM Attacks  
...
9. 9 Months Building AI Safety Evaluation Tools
10. The State of AI Safety Evaluation: A Practitioner's View